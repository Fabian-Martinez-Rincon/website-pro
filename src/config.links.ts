...
export default [
  {
    groupType: 'primary',
    groupName: 'Proyectos Python',
    groupDesc: 'De mis ultimos proyectos',
    links: [
      {
        name: 'Char IT',
  ...
  },
  {
    groupType: 'normal',
    groupName: 'Otros',
    groupDesc: 'Proyectos Secundarios',
    links: [
      {
        name: "Ei Materias",
  ...
  },
  {
    groupType: 'simple',
    groupName: 'Stack',
    groupDesc: 'Herramientas',
    links: [
      {
        name: "VsCode",
        link: 'https://astro.build/',
        avatar: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/2048px-Visual_Studio_Code_1.35_icon.svg.png',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
      {
        name: "Insomnia",
        link: 'https://astro.build/',
        avatar: 'https://static-00.iconduck.com/assets.00/apps-insomnia-icon-2048x2048-2mq9u7v5.png',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
      {
        name: "PostgreSQL",
        link: 'https://astro.build/',
        avatar: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4z-zIkPiGVxNEYZERKm_9zXbFtrgREO7LTA&s',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
      {
        name: "Studio 3T",
        link: 'https://astro.build/',
        avatar: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7HE28raFIl2XCKIrghTtkbEtxVwNJY3444w&s',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
      {
        name: "MongoDB",
        link: 'https://astro.build/',
        avatar: 'https://1000marcas.net/wp-content/uploads/2021/06/MongoDB-Emblem.jpg',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
      {
      ...
      },
      {
        name: "Python",
        link: 'https://astro.build/',
        avatar: 'https://www.svgrepo.com/show/376344/python.svg',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
      {
        name: "Linux",
        link: 'https://astro.build/',
        avatar: 'https://www.logo.wine/a/logo/Linux/Linux-Logo.wine.svg',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
      {
        name: "HTML",
        link: 'https://astro.build/',
        avatar: 'https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/167_Html5_logo_logos-512.png',
        descr: '本站所采用的框架！',
        siteshot: ''
      },
    ]
